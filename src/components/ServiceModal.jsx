      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-2xl max-h-[90vh] overflow-y-auto bg-white rounded-2xl shadow-2xl z-[70] p-6 md:p-8"
          >
            <button
              onClick={onClose}
            ...
            <div className="flex items-center space-x-4 mb-6">
              <div className="w-12 h-12 rounded-xl bg-[#F0F9FC] flex items-center justify-center text-[#0992C2]">
            ...
            <div className="space-y-8">
              ...
              <div className="bg-gray-50 rounded-xl p-6">
                ...
                <p className="text-gray-600 mb-4">{service.useCases.description}</p>
              ...
              <div className="border-t border-gray-100 pt-6">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Custom packages available based on your needs</p>
                  </div>
                  <Button
