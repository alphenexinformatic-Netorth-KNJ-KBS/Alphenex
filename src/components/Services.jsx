...
export const servicesData = [
  {
    ...
    pricing: 'Get your Quote (20% off for first-time clients)',
    highlight: true,
  ...
  },
  {
    ...
    pricing: 'Get your Quote (Custom ROAS strategy)',
    highlight: true,
  ...
  },
  {
    ...
    pricing: 'Get your Quote (Scalable Growth Funnel)',
    highlight: true,
    stat: '35% Lower CPA',
  },
  {
    ...
    pricing: 'Get your Quote (Full Funnel Audit Included)',
    highlight: false,
  ...
  },
  {
    ...
    pricing: 'Get your Quote (Bespoke Scaling Plans)',
    highlight: false,
  ...
  },
  {
    ...
    pricing: 'Get your Quote (Enterprise Bundle Available)',
    highlight: false,
